<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Modify.aspx.cs" Inherits="HF_SMS_APP.Modify" %>

<asp:Content ID="Content1" ContentPlaceHolderID="LogOutSetion" runat="server">
...
<asp:Content ID="Content3" ContentPlaceHolderID="PageData" runat="server"><script src="http://ajax.googleapis.com/ajax/libs/jquery/1.6/jquery.min.js" type="text/javascript"></script>
    <br /><br /><br />
    <script src="http://ajax.googleapis.com/ajax/libs/jqueryui/1.8/jquery-ui.min.js" type="text/javascript"></script>
    <link href="http://ajax.googleapis.com/ajax/libs/jqueryui/1.8/themes/base/jquery-ui.css" rel="Stylesheet" type="text/css" />
    <script type="text/javascript">
        $(function () {
            $("[id$=mtxtdate]").datepicker({
                showOn: 'button',
                dateFormat: 'dd/mm/yy',
                buttonImageOnly: true,
                changeMonth: true,
                changeYear: true,
                buttonImage: "http://localhost/Register/images/calendar.gif"

            });
            $("[id$=mtxtenroldt]").datepicker({
                showOn: 'button',
                dateFormat: 'dd/mm/yy',
                changeMonth: true,
                changeYear: true,
    ...
    <div class="mains">
        <div class="row">
            <h6>ENTER STUDENTID:
            <asp:TextBox runat="server" ID="mtxtsid"></asp:TextBox>
                <asp:Button runat="server" Text="LOAD" value="reset" OnClick="btnLoad_Click" />
            </h6>
            <div class="col-md-4">
                ...
                <table id="ourfrm">
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:TextBox runat="server" ID="mtxtfname"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>LastName</td>
                        <td>
                            <asp:TextBox runat="server" ID="mtxtlastname"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>Gender</td>
                    ...
                    <tr>
                        <td>Tribe</td>
                        <td>
                            <asp:TextBox runat="server" ID="mtxttribe"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>BirthDate</td>
                        <td>
                            <asp:TextBox ID="mtxtdate" runat="server" dateFormatString="mm/dd/yyyy"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>Parent</td>
                        <td>
                            <asp:TextBox runat="server" ID="mtxtparent"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>ContactEmail</td>
                        <td>
                            <asp:TextBox runat="server" ID="mtxtcontactemail"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>ContactPhone</td>
                        <td>
                            <asp:TextBox runat="server" ID="mtxtcontactphone"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>Address</td>
                        <td>
                            <asp:TextBox runat="server" ID="mtxtaddress" TextMode="MultiLine"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>Nationality</td>
                        <td>
                            <asp:DropDownList runat="server" ID="mtxtcountry">
                    ...
                    <tr>
                        <td>Ethnicity</td>
                        <td>
                            <asp:TextBox runat="server" ID="mtxtethnicity"></asp:TextBox>
                        </td>
                    </tr> 
                    <tr>
                        <td>.</td>
            ...
            <div class="col-md-4">
                ...
                <table>
                    <tr>
                        <td>StudentID</td>
                        <td>
                            <asp:TextBox runat="server" ID="mtxtstudentid"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>Class</td>
                        <td>
                            ...
                            <asp:DropDownList runat="server" ID="mtxtclass">
                                <asp:ListItem Value="SELECT">--SELECT CLASS--</asp:ListItem>
                    ...
                    <tr>
                        <td>ClassSuffix</td>
                        <td>
                            <asp:DropDownList runat="server" ID="mtxtclsssufx">
                    ...
                    <tr>
                        <td>ClassTeacher</td>
                        <td>
                            <asp:TextBox runat="server" ID="mtxtclsteacher"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>DateEnrolled</td>
                        <td>
                            <asp:TextBox runat="server" ID="mtxtenroldt"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>GraduationYear</td>
                        <td>
                            <asp:TextBox runat="server" ID="mtxtgradyr"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>OnScholarship</td>
                    ...
                    <tr>
                        <td>Tuition </td>
                        <td>
                            <asp:TextBox runat="server" ID="mtxttuition"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>ClubMembership</td>
                        <td>
                            <asp:TextBox runat="server" ID="mtxtclub"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>Religion</td>
                        <td>
                            <asp:TextBox runat="server" ID="mtxtreligion"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>Marital Status</td>
                        <td>
                            <asp:TextBox runat="server" ID="mtxtmarried"></asp:TextBox>
                        </td>
                    </tr>
        ...
        <table> 
            <tr>
                <td colspan="2">
                    <asp:Button Text="UPDATE" runat="server" CssClass="btn btn-success" ID="btnUpdate" OnClick="btnUpdate_Click" />
