<%@ Page Title="" Language="C#" MasterPageFile="~/AccountantMaster.Master" AutoEventWireup="true" CodeBehind="modifypayment.aspx.cs" Inherits="HF_SMS_APP.modifypayment" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="PageData" runat="server">
    <div class="mrakstable">
         <h4 style="text-align:center;font-family:'Frutiger LT 45';font-weight:bold;font-size:22px;">
             Modify Payment and Receipt Information
            <br />
            <br />
        </h4> 
        <table>
            ...
            <tr>
                ...
                <td colspan="1">
                    <asp:Button Text="UPDATE" ID="btnSave" runat="server" BackColor="Green" OnClick="btnSave_Click" />
